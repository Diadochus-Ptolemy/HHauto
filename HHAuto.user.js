...
function moduleSellItems()
{
    ...
    function setSelling()
    {
        ...
        selling_func = setInterval(() => {
            ...
            {
                if (Number(document.getElementById("SoldMenuCurrentCount").innerHTML) < Number(document.getElementById("SellMenuNumber").value))
                {
                    ...
                    if ($('#inventory .selected .inventory_slots .selected').length > 0)
                    {
                        ...
                        if (can_sell)
                        {
                            ...
                            document.getElementById("SoldMenuCurrentCount").innerHTML = Number(document.getElementById("SoldMenuCurrentCount").innerHTML)+1;
                            document.getElementById("SellMenuCurrentCount").innerHTML = $('#inventory .selected .inventory_slots .slot:not(.empty)').length;
                            return;
                        }
                    }
...
HHAuto_ToolTips.en = {
    ...
    SellMenuText : { elementText: "This will sell the number of items asked starting in display order (first non legendary then legendary)<br> It will sell all non legendary stuff and keep : <br> - 1 set of rainbow (choosen on highest player class stat)<br> - 1 set of mono player class (choosen on highest stats)<br> - 1 set of harmony (choosen on highest stats)<br> - 1 set of endurance (choosen on highest stats)<br> Enter the number of items you want to sell bellow.", tooltip : ""},
